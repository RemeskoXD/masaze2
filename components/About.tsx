...
const About: React.FC = () => {
  return (
    <section id="about" className="py-20 bg-deep-green relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="space-y-6 text-gray-300 font-sans leading-relaxed text-lg">
              ...
              <div className="bg-deep-green/50 border border-gold/30 p-6 rounded-lg my-8">
                <h3 className="font-serif text-xl text-gold mb-4">Moje filozofie</h3>
                <p className="italic text-soft-white">
          ...
          <div className="order-1 lg:order-2 relative group">
            ...
            <img 
              src={IMAGES.owner} 
              alt="Tereza Rozkošná" 
              className="relative rounded-lg shadow-2xl w-full object-cover h-[500px] sepia-[.2] hover:sepia-0 transition-all duration-500"
            />
          </div>
        </div>
      </div>
