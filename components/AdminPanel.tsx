    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-deep-green bg-[url('https://www.transparenttextures.com/patterns/stardust.png')]">
        <div className="w-full max-w-md px-4">
            <form onSubmit={handleLogin} className="bg-[#0f3d26] p-10 rounded-lg border border-gold/30 shadow-2xl">
    ...
    <div className="min-h-screen bg-deep-green text-gray-200 font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        {activeTab === 'reservations' && (
             <div className="bg-[#0f3d26] rounded-lg border border-gold/10 overflow-hidden shadow-xl animate-fade-in">
        ...
        {/* --- PRICES TAB --- */}
        {activeTab === 'prices' && (
            <div className="bg-[#0f3d26] rounded-lg border border-gold/10 overflow-hidden shadow-xl animate-fade-in p-6">
                ...
                <div className="grid grid-cols-1 gap-4">
                    {services.map((service) => (
                        <div key={service.id} className="bg-[#0a2f1c] p-4 rounded border border-gray-600 flex flex-col sm:flex-row justify-between items-center gap-4">
        ...
        {/* --- SETTINGS TAB --- */}
        {activeTab === 'settings' && (
            <div className="bg-[#0f3d26] p-8 rounded-lg border border-gold/10 shadow-xl animate-fade-in">
