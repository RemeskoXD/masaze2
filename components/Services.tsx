      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="inline-flex flex-col sm:flex-row items-center justify-center gap-3 bg-gold/5 border border-gold/20 px-6 py-4 rounded-2xl mx-auto mt-6">
             ...
             <p className="font-medium text-text-dark text-sm sm:text-base text-center sm:text-left">
               <span className="font-bold text-gold-dark uppercase tracking-wide mr-2 block sm:inline mb-1 sm:mb-0">KE KAŽDÉ MASÁŽI NAVÍC:</span>
